...
const navItems = [
  ...
  { path: '/financial',    icon: IndianRupee,     label: 'Financial',    module: 'financial' },
  { path: '/procurement',  icon: ShoppingCart,     label: 'Procurement',  module: 'procurement' },
  { path: '/hrms',         icon: Users,            label: 'HRMS',         module: 'hrms' },
  { path: '/compliance',   icon: FileText,         label: 'Compliance',   module: 'compliance' },
  { path: '/einvoicing',   icon: Receipt,          label: 'E-Invoicing',  module: 'einvoicing' },
